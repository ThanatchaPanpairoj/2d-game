 ...
 * @version (6/6/15)
 */
public class JustinLiu extends Enemy implements Boss
{
    /**
    ...
    public JustinLiu(int hp, int fWidth, int fHeight) {
        super("Justin Liu", 100, fWidth, fHeight, (int)(Math.random() * fWidth), (int)(Math.random() * fHeight), new Color((float)Math.random(), (float)Math.random(), (float)Math.random()), 5);
        changeMaxHp(hp);
        changeHp(hp);
    }
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.drawString("Justin Liu", x - 60, y + 10);
